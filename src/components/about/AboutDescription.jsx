        ...
        <div className=" mx-auto grid md:grid-cols-2 gap-8 items-center shadow-xs shadow-accent p-7 rounded-xl">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-6">
              AI Scholar was founded with the vision of revolutionizing your
              education through AI-powered learning experiences. Our mission is
              to empower students and educators by providing a seamless,
              intuitive, and intelligent course management system.
            </p>
