...
const LearningPathForm = () => {
  ...
  return (
    <div className=" mx-auto p-6 space-y-6">
      <h2 className="text-3xl font-bold mb-4">Get Your Personalized Learning Path</h2>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        />
        {errors.level && <p className="text-error text-sm">{errors.level.message}</p>}
        ...
        />
        {errors.interest && <p className="text-error text-sm">{errors.interest.message}</p>}
        ...
        />
        {errors.time && <p className="text-error text-sm">{errors.time.message}</p>}
        ...
        <input
          ...
          className="input input-bordered w-full"
          {...register("learningStyle", { required: "This field is required" })}
        />
        {errors.learningStyle && <p className="text-error text-sm">{errors.learningStyle.message}</p>}
...
{/* 
      {result && (
        <div className="mt-6 bg-base-200 p-4 rounded-box">
          <h3 className="text-lg font-semibold mb-2">📚 Your Personalized Path:</h3>
