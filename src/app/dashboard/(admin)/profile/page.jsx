...
export default function Profile() {
  ...
  const { name, email, role, image } = userProfileInfo;
              ...
              <input
                ...
                onChange={(e) => {
                  if (e.target.files && e.target.files[0]) {
                    ...
                    reader.onload = (event) => {
                      // handle new image preview or upload
                    };
        ...
        <div className="pt-20">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-gray-600 mt-1">{email || "No email provided"}</p>
            </div>
            <button
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  disabled
                  className="mt-1 px-2 py-1 block w-full rounded-md border bg-gray-100 text-gray-600 cursor-not-allowed"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="mt-1 px-2 block w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring-blue-500"
                />
              </div>
            </div>
